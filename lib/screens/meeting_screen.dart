...
class _MeetingScreenState extends State<MeetingScreen> {
  ...
  Widget build(BuildContext context) {
    int _selectedIndex = 0; // Define the selected index state at the widget level if not already defined
                ...
                const Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 20.0),
                      child: Text(
                        "toplantıda olmasını istediğiniz kişilerle paylaşın.",
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 12,
                            fontWeight: FontWeight.bold),
                ...
                Container(
                    ...
                    child: _isVideoOff
                      ...
                      child: HMSVideoView(
                        ...
                        : const Center(child: Text("Görüntü Bulunamadı"))),
                Align(
